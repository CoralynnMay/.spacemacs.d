...
This function should only modify configuration layer settings."
  (setq-default
   ...
   '(
     (html :variables scss-enable-lsp t
...
(defun dotspacemacs/user-config ()
  ...
  (defun angular-generate (type)
    (interactive)
    (projectile-with-default-dir (projectile-project-root)  (shell-command (format "ng generate %s %s" type (read-string (format "%s name: " type))))))
  ...
  (defun format-on-save-hook () (add-hook 'before-save-hook 'prettier-js nil 'make-it-local))
  (add-hook 'scss-mode-hook 'format-on-save-hook)
  (add-hook 'web-mode-hook 'format-on-save-hook)
  (add-hook 'typescript-mode-hook 'format-on-save-hook)
  )
